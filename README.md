...
- [[IEEE-Proc](https://arxiv.org/abs/2109.12894)] Training Spiking Neural Networks Using Lessons From Deep Learning, **2023**.
...
- [[ArXiv](https://arxiv.org/abs/2310.00564)] DYNAP-SE2: a scalable multi-core dynamic neuromorphic asynchronous spiking neural network processor [__`digital`__][__`asic`__][__`async`__]
...
- [[IEEE-Access](https://ieeexplore.ieee.org/abstract/document/9763524)] A 18.7 TOPS/W Mixed-Signal Spiking Neural Network Processor With 8-bit Synaptic Weight On-Chip Learning That Operates in the Continuous-Time Domain. [__`mixed-signal`__][__`online-learning`__][__`asic`__]
